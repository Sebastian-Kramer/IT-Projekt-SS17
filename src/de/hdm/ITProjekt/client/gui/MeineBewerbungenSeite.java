...
//		private void bewerbungL�schen(){
//		bewerbungL�schen_button.addClickHandler(new ClickHandler(){
//
//			@Override
//		public void onClick(ClickEvent event) {
//				if(ssm != null){
//					Bewerbung ausgew�hlteBew = new Bewerbung();
//					ausgew�hlteBew.setID(ssm.getSelectedObject().getID());
//					adminService.deleteBewerbung(ausgew�hlteBew, new AsyncCallback<Void>(){
//
//						@Override
//						public void onFailure(Throwable caught) {
//							// TODO Auto-generated method stub
